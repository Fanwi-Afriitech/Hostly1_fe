...
const Chatbot = memo (() => {
    const theme = {
        ...
        botBubbleColor: '#007bff', // Bot message bubble
        botFontColor: '#fff', // Bot message text
        userBubbleColor: 'purple', // User message bubble
        userFontColor: '#FFF', // User message text
      };
    const steps = [
        {
          id: '1',
      ...
      console.log('Chatbot is rendered');
